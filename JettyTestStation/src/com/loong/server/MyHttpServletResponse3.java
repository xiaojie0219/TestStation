...
public class MyHttpServletResponse3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger logger = Logger.getLogger(MyHttpServletResponse3.class);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws IOException {
		...
		try {
			...
			if("".equals(reqBodyData) || reqBodyData==null){
				...
				String resStr = getAgentKey.getPrivateKey();
